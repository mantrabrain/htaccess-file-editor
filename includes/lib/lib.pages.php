...
function WPHE_admin_menu()
{
    ...
    if (current_user_can('activate_plugins')) {
        add_menu_page('Htaccess File Editor', 'Htaccess', 'activate_plugins',
            $WPHE_dirname, 'WPHE_view_page', HTACCESS_FILE_EDITOR_PLUGIN_URI . 'style/img/wphe-mini.png');
        ...
        wp_enqueue_style('wphe-style', HTACCESS_FILE_EDITOR_PLUGIN_URI . 'assets/css/htaccess-file-editor.css');
    }
    unset($WPHE_dirname);
}
