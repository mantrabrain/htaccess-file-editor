...
if(!function_exists('wp_get_current_user')){
	if(file_exists(ABSPATH.'wp-includes/pluggable.php')){
		...
		wp_die(__('Plugin Htaccess File Editor Error: File "/wp-includes/pluggable.php" does not exists!', 'wphe'));
	}
}
...
if(!function_exists('current_user_can')){
	if(file_exists(ABSPATH.'wp-includes/capabilities.php')){
		...
		wp_die(__('Plugin Htaccess File Editor Error: File "/wp-includes/capabilities.php" does not exists!', 'wphe'));
	}
}
